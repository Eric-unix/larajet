...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Caveat:wght@400;500;600;700&family=Josefin+Slab:ital,wght@0,300;0,400;0,600;0,700;1,300&display=swap" rel="stylesheet">
    ...
    <title>Pagina Orientada a Servicios</title>
<body>
<title>Laravel</title>
...
<div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
    ...
    @endif
        ...
        <section class="galeria" id="galeria">
            <div class="foto">
                <img src="img/1.jpg" alt="">medico general
            </div>
            <div class="foto">
                <img src="img/2.jpg" alt="">medico cirujano 
            </div>
            <div class="foto">
                <img src="img/3.jpg" alt="">medico pediatra ]
            </div>
            <div class="foto">
                <img src="" alt=""> enfermera     
            </div>
            <div class="foto">
                <img src="" alt="">
            </div>
        ...
        <section class="ubicacion" id="ubicacion">
            <div class="contenedor">
                ...
                <div class="direccion">
                    <p class="telefono">Numero de Contacto: 2471320883</p>
                    <p class="correo">Correo de Contacto: Misalud@gmail.com</p>
                </div>
                <nav class="menu">
                    <ul>
                        <li><a href="#"><i class="fa fa-twitter"><a target="_blank" href="http://www.facebook.com"></i></a></li>
                        <li><a href="#"><i class="fa fa-facebook"> <a target="_blank" href="http://www.facebook.com"></i></a></li>
                        <li><a href="#">Contacto<i class="icono fa fa-envelope"></i></a></li>
                    </ul>
                </nav>
                <div class="horarios">
                    <h4></h4>
                    <p class="entre-semana"><br> </p>
                    <p class="fin-semana"><br></p>
                </div>
            </div>
        </section>

        <section class="mapa">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d30123.346823943077!2d-97.92577805376246!3d19.30764444368545!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85cffc84a59d6b89%3A0x53024f948d1f4a99!2sInsurgentes%20213%2C%20Centro%2C%2090501%20Huamantla%2C%20Tlax.!5e0!3m2!1ses-419!2smx!4v1624218355041!5m2!1ses-419!2smx" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
        </section>
    ...
    <footer>
        <div class="copyright">
            <p>copyright Eric Barrera @ 2021</p>
        </div>
    </footer>
